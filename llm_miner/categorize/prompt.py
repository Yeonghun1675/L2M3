...
- You must return ["synthesis condition"] only when the paragraph includes specific IR information like 'IR: 3137(m), 2359(m), 1655(s), 1493(s), 1262(s), 1210(s), 1148(s), 805(m), 668(m), 589(m).
- You must return ["property"] only when the paragraph includes specific `name`, `value` and `unit` of the property like '2500 m2/g'.
...
- You must return ["else"] if there is no 'IR' information in the paragraph even though a word 'synthesis' exists in the paragraph.
